...
function compareValues(
  a: MoldeScheduleEntry,
  b: MoldeScheduleEntry,
  key: SortKey,
): number {
    ...
    <div className="space-y-4">
      <label className="block">
        ...
        <input
          ...
          aria-label="Search Molde ship schedule"
