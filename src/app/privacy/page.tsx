...
export const metadata: Metadata = buildPageMetadata({
  ...
  description:
    "Privacy policy for Molde Shore Excursions: how this independent cruise planning website handles information.",
  path: "/privacy",
});
...
export default function PrivacyPage() {
  return (
    <ContentPage
      title="Privacy Policy"
      lead="This privacy notice describes Molde Shore Excursions as it operates today: an informational cruise planning site without live booking or payment processing."
    ...
    >
      <section>
        ...
        <p>
          ...
          {siteConfig.url}. It provides independent Molde cruise-port planning
          information.
        </p>
      </section>
