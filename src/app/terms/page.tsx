...
export const metadata: Metadata = buildPageMetadata({
  title: "Terms of Use",
  description:
    "Terms of use for Molde Shore Excursions: independent cruise planning information for Molde port days.",
  path: "/terms",
});
...
export default function TermsPage() {
  return (
    <ContentPage
      title="Terms of Use"
      lead="These terms cover use of the Molde Shore Excursions website as an independent informational planning resource."
      ...
      ctaTitle="Plan your Molde cruise day"
      ctaText="Explore city and Varden options or a longer Atlantic Ocean Road day, then verify timings with your cruise line."
      ctaHref="/excursions"
    ...
    >
      <section>
        ...
        <p>
          ...
          information about Molde. It is not a substitute for official
